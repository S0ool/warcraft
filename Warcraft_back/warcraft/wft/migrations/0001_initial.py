    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('target', models.ManyToManyField(blank=True, related_name='skills', to='wft.targets')),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hotkey', models.CharField(max_length=1)),
                ('hotkey_ru', models.CharField(max_length=1)),
                ('needed_technologies', models.JSONField(blank=True, default=dict)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_hero', models.BooleanField(blank=True, default=False)),
                ...
                ('type_unit', models.ManyToManyField(blank=True, related_name='char', to='wft.targets')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('abilities', models.ManyToManyField(blank=True, related_name='items', to='wft.skill')),
            ],
            options={
